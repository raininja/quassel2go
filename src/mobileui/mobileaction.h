...
#ifndef MOBILEACTION_H_
#define MOBILEACTION_H_
 ...
 */
class MobileAction : public QAction {
  Q_OBJECT
  ...
  public:
    ...
    explicit MobileAction(QObject *parent);
    MobileAction(const QString &text, QObject *parent, const QObject *receiver = 0, const char *slot = 0, const QKeySequence &shortcut = 0);
    MobileAction(const QIcon &icon, const QString &text, QObject *parent, const QObject *receiver = 0, const char *slot = 0, const QKeySequence &shortcut = 0);
...
Q_DECLARE_OPERATORS_FOR_FLAGS(MobileAction::ShortcutTypes)

#else /* HAVE_KDE */
#include <KAction>

class MobileAction : public KAction {
  Q_OBJECT
