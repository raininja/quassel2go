...
#ifndef ABSTRACTITEMPRESENTER_H
#define ABSTRACTITEMPRESENTER_H
...
class AbstractItemPresenter : public QObject {
  Q_OBJECT

public:
  AbstractItemPresenter(QObject *parent = 0);
  virtual ~AbstractItemPresenter();
